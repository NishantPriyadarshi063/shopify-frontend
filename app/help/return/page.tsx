...
export default function ReturnPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/help/success?id=${req.id}&type=return&email=${encodeURIComponent(form.customer_email.trim())}`);
    } catch (err) {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <Textarea
            ...
            placeholder="Why are you returning? Product condition, wrong item, etc."
            value={form.reason}
