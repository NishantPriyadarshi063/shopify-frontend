...
export default function RefundPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/help/success?id=${req.id}&type=refund&email=${encodeURIComponent(form.customer_email.trim())}`);
    } catch (err) {
    ...
    <PageContainer>
      ...
      >
        ...
        <p className="mt-2 text-[var(--muted)]">
          Share your details and any supporting photos so we can process your refund.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <Textarea
            ...
            placeholder="Why do you need a refund? Damage, wrong item, etc."
            value={form.reason}
